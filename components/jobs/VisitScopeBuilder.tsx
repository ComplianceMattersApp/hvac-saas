...
export default function VisitScopeBuilder({
  ...
  return (
    <div className="space-y-4">
      <>
      {hideSummaryField || (jobType === "ecc" && hideEccTripContext) ? (
        <input type="hidden" name={summaryName} value={hideEccTripContext && jobType === "ecc" ? "" : summary} />
      ) : jobType === "service" ? (

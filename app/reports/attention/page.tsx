...
export default async function AttentionCenterPage({ searchParams }: { searchParams: Promise<{ sync?: string; stripe_link?: string }> }) {
  ...
  const canRepairStripeIdentity = internalUser.role === "admin";

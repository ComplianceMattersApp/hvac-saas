...
export default function FieldOutcomePanel(props: FieldOutcomePanelProps) {
  return (
    ...
    >
      ...
      <div className="mt-3 w-full rounded-xl border border-amber-200/80 bg-amber-50/40 p-3">
        <div>
          <p className="text-xs font-semibold text-amber-900">Need parts, approval, or unable to complete?</p>
          <p className="mt-1 text-xs leading-5 text-amber-900/90">
            Choose an exception path if this visit cannot be finished today.
          </p>
        </div>

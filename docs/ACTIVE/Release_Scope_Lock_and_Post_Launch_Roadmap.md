...
- Access-control prerequisite for Billing Register / Payments Register V1 is satisfied. Billing Register V1 may resume next-lane implementation under existing helper/server-side gates; UI/actions remain deferred in this docs-only pass.

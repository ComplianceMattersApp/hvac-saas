...
| 9B | SMS / On-My-Way Messaging | Planned — see `docs/ACTIVE/SMS_Compliance_and_Consent_Model_Spec.md` for activation gates (10 gates) and `docs/ACTIVE/SMS_Recipient_and_Contact_Role_Model_Spec.md` for recipient/contact role model (audit decision C — 2026-05-14); a first-class recipient/contact role model and consent/suppression model are required before any live send |

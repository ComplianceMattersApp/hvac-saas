...
| 9B | SMS / On-My-Way Messaging | Planned — see `docs/ACTIVE/SMS_Compliance_and_Consent_Model_Spec.md` for activation gates (10 gates), `docs/ACTIVE/SMS_Recipient_and_Contact_Role_Model_Spec.md` for recipient/contact role model (audit decision C — 2026-05-14), and `docs/ACTIVE/SMS_Recipient_Consent_Schema_Design_Plan.md` for future schema design; a first-class recipient/contact role model, consent/suppression model, and schema are required before any live send |

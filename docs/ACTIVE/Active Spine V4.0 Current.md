...
- Future estimate/customer-facing roadmap remains deferred after this closeout:
  ...
  - future workflow wording should separate `Send Estimate` from `Mark Sent Manually` more explicitly without collapsing communication truth into lifecycle truth
  ...
  - multi-option quoting, customer approval, conversion, deposits/payments, and public/customer portal delivery remain later design tracks and are not part of the current baseline

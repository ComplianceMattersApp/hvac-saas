...
- Manual Text Logging Wording Clarification is complete and pushed in commit `36460b8`:
  ...
  - SMS On-The-Way V1 Workflow Simplification is locked:
    ...
    - F5C should be planned/audited before implementation and likely becomes non-sending blocked/skipped/ready `sms_message_intents` creation from eligible durable `on_my_way` anchors; provider send/webhook/activation remain deferred.

...
function makeAdmin() {
  ...
  const maybeQueues: Record<string, any[]> = {
    ...
    internal_invoice_payments: [
      { data: { id: "payment-1", account_owner_user_id: OWNER, invoice_id: INVOICE, job_id: JOB, amount_cents: 85000, payment_status: "recorded", payment_method: "card_stripe_online", processor_name: null, processor_payment_reference: null, processor_charge_id: null, stripe_payment_intent_id: null }, error: null },

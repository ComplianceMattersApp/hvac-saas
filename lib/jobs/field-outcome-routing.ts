...
const FIELD_OUTCOME_ROUTES: Record<FieldOutcomeCode, FieldOutcomeRoute> = {
  ...
  parts_needed: {
    ...
    description: "Today's visit is complete, and follow-up is held until materials are handled.",
  ...
  approval_needed: {
    ...
    description: "Today's visit is complete, and follow-up is held until the customer or responsible party approves the next step.",
    existingIntent: "set_waiting_reason",
    applicability: "default_closeout",
    visibleInDefaultCloseout: true,
    officeOwnedAfterSubmission: true,
  ...
  unable_to_complete: {
    ...
    label: "Other",
    description: "Today's visit is complete, and office review is needed to decide the next step.",
    existingIntent: "set_waiting_reason",
    applicability: "default_closeout",
    visibleInDefaultCloseout: true,
    officeOwnedAfterSubmission: true,

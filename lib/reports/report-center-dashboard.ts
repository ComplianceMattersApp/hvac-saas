  ...
  return {
    topCards: [
      ...
      },
      {
        ...
        helperText: "Field-complete work still open with admin follow-up.",
      ...
      },
      {
        ...
        helperText: "Current unresolved continuity workload.",
      ...
      },
      {
        ...
        helperText: "Open quality pressure where multiple visits are already linked.",
      ...
      },
      {
        ...
        helperText: "Issued invoice totals only. Payment collection is intentionally excluded.",
        href: null,
        tone: "slate",
      },
    ],

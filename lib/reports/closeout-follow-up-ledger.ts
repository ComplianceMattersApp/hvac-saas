...
const JOB_BASE_SELECT =
  "id, job_display_number, title, visit_scope_summary, job_type, status, ops_status, service_case_id, created_at, scheduled_date, field_complete, field_complete_at, invoice_complete, billing_disposition, certs_complete, permit_number, contractor_id, contractors(name), customer_id, location_id, customer_first_name, customer_last_name, job_address, city, follow_up_date, next_action_note, action_required_by";
const JOB_BASE_SELECT_COMPAT =
  "id, job_display_number, title, visit_scope_summary, job_type, status, ops_status, service_case_id, created_at, scheduled_date, field_complete, field_complete_at, invoice_complete, certs_complete, permit_number, contractor_id, contractors(name), customer_id, location_id, customer_first_name, customer_last_name, job_address, city, follow_up_date, next_action_note, action_required_by";

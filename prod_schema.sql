...
\restrict qsjlWlRP4pVQfXxTzsuUcdfStee0O90814XYEhTGGJNv8e9UYPoeX9dhyIKUVcm
...
--
-- Name: prevent_job_parent_cycles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_job_parent_cycles() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare
  cycle_found boolean;
...
CREATE FUNCTION public.search_customers(search_text text, result_limit integer DEFAULT 25) RETURNS TABLE(customer_id uuid, full_name text, phone text, email text, locations_count bigint, sample_location_id uuid, sample_address text, sample_city text)
    LANGUAGE sql
    AS $$
  with q as (
...
--
-- Name: customer_locations_summary; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.customer_locations_summary AS
...
--
-- Name: ecc_test_runs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ecc_test_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: job_equipment; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: job_systems; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.job_systems (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    job_id uuid NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: job_visits; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: job_visit_test_summary; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.job_visit_test_summary AS
...
--
-- Name: location_jobs; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.location_jobs AS
 SELECT location_id,
    id AS job_id,
    title,
    job_type,
...
--
-- Name: location_summary; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.location_summary AS
...
--
-- Name: ecc_test_runs ecc_test_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_equipment job_equipment_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_systems job_systems_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_job_id_visit_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: attachments_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: calendar_events_start_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: contractor_users_one_owner_per_contractor; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: contractor_users_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: contractors_owner_user_id_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX contractors_owner_user_id_key ON public.contractors USING btree (owner_user_id) WHERE (owner_user_id IS NOT NULL);
...
--
-- Name: customers_email_trgm_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: customers_full_name_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: customers_full_name_trgm_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: customers_owner_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: customers_phone_digits_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_job_id_type_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_system_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_unique_visit_equipment_test; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_visit_completed_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs_visit_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: equipment_location_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: equipment_model_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: equipment_owner_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: equipment_serial_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_equipment_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_equipment_system_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_events_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_events_job_id_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_events_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_events_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_systems_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_systems_job_id_name_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_closed_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_job_id_visit_number_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_owner_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_scheduled_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: job_visits_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_contractor_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_follow_up_date_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_lifecycle_state_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_location_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_ops_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: jobs_parent_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: locations_address_trgm_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: locations_city_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: locations_city_trgm_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: locations_customer_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: locations_owner_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: notifications_job_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs set_ecc_test_runs_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_ecc_test_runs_updated_at BEFORE UPDATE ON public.ecc_test_runs FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: job_equipment set_job_equipment_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_job_equipment_updated_at BEFORE UPDATE ON public.job_equipment FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: jobs trg_prevent_job_parent_cycles; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prevent_job_parent_cycles BEFORE INSERT OR UPDATE OF parent_job_id ON public.jobs FOR EACH ROW EXECUTE FUNCTION public.prevent_job_parent_cycles();
...
--
-- Name: contractor_users contractor_users_contractor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contractor_users contractor_users_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contractors contractors_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs ecc_test_runs_equipment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs ecc_test_runs_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs ecc_test_runs_system_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs ecc_test_runs_visit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_equipment job_equipment_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_equipment job_equipment_system_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_events job_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_systems job_systems_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jobs jobs_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jobs jobs_parent_job_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: locations locations_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: notifications notifications_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: services services_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: attachments attachments_contractor_insert_own_jobs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: attachments attachments_contractor_select_own_jobs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: attachments attachments_internal_full_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_events contractor_insert_own_job_events_limited; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY contractor_insert_own_job_events_limited ON public.job_events FOR INSERT TO authenticated WITH CHECK (((EXISTS ( SELECT 1
   FROM (public.jobs j
     JOIN public.contractor_users cu ON ((cu.contractor_id = j.contractor_id)))
  WHERE ((cu.user_id = auth.uid()) AND (j.id = job_events.job_id)))) AND (event_type = ANY (ARRAY['contractor_note'::text, 'contractor_correction_submission'::text, 'attachment_added'::text]))));


--
-- Name: jobs contractor_insert_own_jobs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_equipment contractor_select_own_job_equipment; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_events contractor_select_own_job_events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_systems contractor_select_own_job_systems; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: jobs contractor_select_own_jobs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY contractor_select_own_jobs ON public.jobs FOR SELECT TO authenticated USING ((contractor_id = ( SELECT cu.contractor_id
   FROM public.contractor_users cu
  WHERE (cu.user_id = auth.uid())
 LIMIT 1)));
...
--
-- Name: customers customers_delete_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: customers customers_insert_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: customers customers_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: customers customers_update_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ecc_test_runs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ecc_test_runs ENABLE ROW LEVEL SECURITY;

--
-- Name: ecc_test_runs ecc_test_runs_contractor_select_own; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY ecc_test_runs_contractor_select_own ON public.ecc_test_runs FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.jobs j
     JOIN public.contractor_users cu ON ((cu.contractor_id = j.contractor_id)))
  WHERE ((cu.user_id = auth.uid()) AND (j.id = ecc_test_runs.job_id)))));


--
-- Name: ecc_test_runs ecc_test_runs_internal_full_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipment equipment_delete_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipment equipment_insert_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipment equipment_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipment equipment_update_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_equipment internal_full_access_job_equipment; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_events internal_full_access_job_events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_systems internal_full_access_job_systems; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: jobs internal_full_access_jobs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY internal_full_access_jobs ON public.jobs TO authenticated USING ((NOT (EXISTS ( SELECT 1
   FROM public.contractor_users cu
  WHERE (cu.user_id = auth.uid()))))) WITH CHECK ((NOT (EXISTS ( SELECT 1
   FROM public.contractor_users cu
  WHERE (cu.user_id = auth.uid())))));
...
--
-- Name: job_equipment; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: job_systems; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.job_systems ENABLE ROW LEVEL SECURITY;

--
-- Name: job_visits; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.job_visits ENABLE ROW LEVEL SECURITY;

--
-- Name: job_visits job_visits_delete_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_insert_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: job_visits job_visits_update_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: locations locations_delete_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: locations locations_insert_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: locations locations_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: locations locations_update_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects storage_contractor_insert_own_job_attachments; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY storage_contractor_insert_own_job_attachments ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'attachments'::text) AND (EXISTS ( SELECT 1
   FROM ((public.attachments a
     JOIN public.jobs j ON ((j.id = a.entity_id)))
     JOIN public.contractor_users cu ON ((cu.contractor_id = j.contractor_id)))
  WHERE ((cu.user_id = auth.uid()) AND (a.entity_type = 'job'::text) AND (a.storage_path = objects.name))))));


--
-- Name: objects storage_contractor_read_own_job_attachments; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY storage_contractor_read_own_job_attachments ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'attachments'::text) AND (EXISTS ( SELECT 1
   FROM ((public.attachments a
     JOIN public.jobs j ON ((j.id = a.entity_id)))
     JOIN public.contractor_users cu ON ((cu.contractor_id = j.contractor_id)))
  WHERE ((cu.user_id = auth.uid()) AND (a.entity_type = 'job'::text) AND (a.storage_path = objects.name))))));
...
--
-- Name: objects storage_internal_full_access; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY storage_internal_full_access ON storage.objects TO authenticated USING (((bucket_id = 'attachments'::text) AND (NOT (EXISTS ( SELECT 1
   FROM public.contractor_users cu
  WHERE (cu.user_id = auth.uid())))))) WITH CHECK (((bucket_id = 'attachments'::text) AND (NOT (EXISTS ( SELECT 1
   FROM public.contractor_users cu
  WHERE (cu.user_id = auth.uid()))))));
...
\unrestrict qsjlWlRP4pVQfXxTzsuUcdfStee0O90814XYEhTGGJNv8e9UYPoeX9dhyIKUVcm

-- Repair production drift for field charge proposals schema only.
-- Mirrors 20260605110000_field_charge_proposals_foundation.sql without
-- seeding rows or mutating invoice, payment, allocation, or provider truth.

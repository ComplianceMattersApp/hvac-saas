...
ALTER FUNCTION "public"."handle_contractor_invite_accept"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."is_job_owned_by_current_contractor"("p_job_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."mark_job_needs_internal_review"("p_job_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."mark_job_needs_internal_review"("p_job_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."portal_job_counts"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."portal_job_counts"("p_contractor_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."prevent_job_parent_cycles"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."search_customers"("search_text" "text", "result_limit" integer) OWNER TO "postgres";
...
ALTER TABLE "public"."contractor_invites" OWNER TO "postgres";
...
ALTER TABLE "public"."contractor_users" OWNER TO "postgres";
...
ALTER VIEW "public"."customer_locations_summary" OWNER TO "postgres";
...
ALTER TABLE "public"."ecc_test_runs" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."job_equipment"."heating_capacity_kbtu" IS 'Heating output capacity in KBTU/h. Used exclusively by furnace and heat-only equipment.
...
COMMENT ON COLUMN "public"."job_equipment"."heating_efficiency_percent" IS 'Rated heating efficiency as a percentage (e.g. AFUE 80 = 80).
...
COMMENT ON COLUMN "public"."job_equipment"."heating_output_btu" IS 'Heating output in BTU/h as entered at intake or equipment setup.
...
ALTER TABLE "public"."job_systems" OWNER TO "postgres";
...
ALTER TABLE "public"."job_visits" OWNER TO "postgres";
...
ALTER VIEW "public"."job_visit_test_summary" OWNER TO "postgres";
...
ALTER VIEW "public"."location_jobs" OWNER TO "postgres";
...
ALTER TABLE "public"."service_cases" OWNER TO "postgres";
...
CREATE POLICY "contractor_insert_own_job_events_limited" ON "public"."job_events" FOR INSERT TO "authenticated" WITH CHECK (((EXISTS ( SELECT 1
   FROM ("public"."jobs" "j"
     JOIN "public"."contractor_users" "cu" ON (("cu"."contractor_id" = "j"."contractor_id")))
  WHERE (("cu"."user_id" = "auth"."uid"()) AND ("j"."id" = "job_events"."job_id")))) AND ("event_type" = ANY (ARRAY['contractor_note'::"text", 'contractor_correction_submission'::"text", 'attachment_added'::"text", 'contractor_job_created'::"text", 'contractor_schedule_updated'::"text", 'retest_ready_requested'::"text"]))));
...
CREATE POLICY "contractor_users_internal_select_owner_scope" ON "public"."contractor_users" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."internal_users" "actor"
     JOIN "public"."contractors" "c" ON (("c"."owner_user_id" = "actor"."account_owner_user_id")))
  WHERE (("actor"."user_id" = "auth"."uid"()) AND ("actor"."is_active" = true) AND ("c"."id" = "contractor_users"."contractor_id")))));
...
CREATE POLICY "internal_notes_delete_own" ON "public"."internal_notes" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "internal_notes_insert_own" ON "public"."internal_notes" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "internal_notes_select_own" ON "public"."internal_notes" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "internal_notes_update_own" ON "public"."internal_notes" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "notifications_internal_full_access" ON "public"."notifications" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."internal_users" "iu"
  WHERE (("iu"."user_id" = "auth"."uid"()) AND ("iu"."is_active" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."internal_users" "iu"
  WHERE (("iu"."user_id" = "auth"."uid"()) AND ("iu"."is_active" = true)))));
...
CREATE POLICY "profiles_internal_select_account_scope" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."internal_users" "actor"
  WHERE (("actor"."user_id" = "auth"."uid"()) AND ("actor"."is_active" = true) AND (("profiles"."id" = "actor"."user_id") OR (EXISTS ( SELECT 1
           FROM "public"."internal_users" "teammate"
          WHERE (("teammate"."user_id" = "profiles"."id") AND ("teammate"."account_owner_user_id" = "actor"."account_owner_user_id")))) OR (EXISTS ( SELECT 1
           FROM ("public"."contractor_users" "cu"
             JOIN "public"."contractors" "c" ON (("c"."id" = "cu"."contractor_id")))
          WHERE (("cu"."user_id" = "profiles"."id") AND ("c"."owner_user_id" = "actor"."account_owner_user_id")))))))));
...
CREATE POLICY "service_cases_contractor_select" ON "public"."service_cases" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."jobs" "j"
     JOIN "public"."contractor_users" "cu" ON (("cu"."contractor_id" = "j"."contractor_id")))
  WHERE (("cu"."user_id" = "auth"."uid"()) AND ("j"."service_case_id" = "service_cases"."id") AND ("j"."deleted_at" IS NULL)))));
...
GRANT ALL ON FUNCTION "public"."handle_contractor_invite_accept"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_contractor_invite_accept"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_contractor_invite_accept"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_job_owned_by_current_contractor"("p_job_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_job_owned_by_current_contractor"("p_job_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_job_owned_by_current_contractor"("p_job_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."mark_job_needs_internal_review"("p_job_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_job_needs_internal_review"("p_job_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_job_needs_internal_review"("p_job_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."portal_job_counts"() TO "anon";
GRANT ALL ON FUNCTION "public"."portal_job_counts"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."portal_job_counts"() TO "service_role";



GRANT ALL ON FUNCTION "public"."portal_job_counts"("p_contractor_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."portal_job_counts"("p_contractor_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."portal_job_counts"("p_contractor_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."prevent_job_parent_cycles"() TO "anon";
GRANT ALL ON FUNCTION "public"."prevent_job_parent_cycles"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."prevent_job_parent_cycles"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_customers"("search_text" "text", "result_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_customers"("search_text" "text", "result_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_customers"("search_text" "text", "result_limit" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."contractor_invites" TO "anon";
GRANT ALL ON TABLE "public"."contractor_invites" TO "authenticated";
GRANT ALL ON TABLE "public"."contractor_invites" TO "service_role";



GRANT ALL ON TABLE "public"."contractor_users" TO "anon";
GRANT ALL ON TABLE "public"."contractor_users" TO "authenticated";
GRANT ALL ON TABLE "public"."contractor_users" TO "service_role";
...
GRANT ALL ON TABLE "public"."customer_locations_summary" TO "anon";
GRANT ALL ON TABLE "public"."customer_locations_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."customer_locations_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."ecc_test_runs" TO "anon";
GRANT ALL ON TABLE "public"."ecc_test_runs" TO "authenticated";
GRANT ALL ON TABLE "public"."ecc_test_runs" TO "service_role";
...
GRANT ALL ON TABLE "public"."job_systems" TO "anon";
GRANT ALL ON TABLE "public"."job_systems" TO "authenticated";
GRANT ALL ON TABLE "public"."job_systems" TO "service_role";



GRANT ALL ON TABLE "public"."job_visits" TO "anon";
GRANT ALL ON TABLE "public"."job_visits" TO "authenticated";
GRANT ALL ON TABLE "public"."job_visits" TO "service_role";



GRANT ALL ON TABLE "public"."job_visit_test_summary" TO "anon";
GRANT ALL ON TABLE "public"."job_visit_test_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."job_visit_test_summary" TO "service_role";



GRANT ALL ON TABLE "public"."location_jobs" TO "anon";
GRANT ALL ON TABLE "public"."location_jobs" TO "authenticated";
GRANT ALL ON TABLE "public"."location_jobs" TO "service_role";



GRANT ALL ON TABLE "public"."location_summary" TO "anon";
GRANT ALL ON TABLE "public"."location_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."location_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."service_cases" TO "anon";
GRANT ALL ON TABLE "public"."service_cases" TO "authenticated";
GRANT ALL ON TABLE "public"."service_cases" TO "service_role";
